module.exports = {
  ...
  Explanatory: {
    ...
    Update_description: '<ul><li>修復部分BUG</li></ul>',
    Toolsinfo: '開發者工具箱只針對MOD開發人員開放，工具箱内包含本工具内置的數據信息和一些實用工具，如需申請開發者認證許可，請在下方填寫您曾經發佈過的一個Mod地址並提交申請，收到您的申請后我們會儘快處理。'
  },
